...
public class KeycloakUserClient {
        ...
        try {
            ...
            if (response == null) {
                throw new KeycloakIntegrationException(
                        "Resposta nula ao criar usuário no Keycloak"
                );
            }
            ...
            if (locationHeader == null) {
                throw new KeycloakIntegrationException(
                        "Header Location ausente na resposta do Keycloak"
                );
            }

            String userId = extractKeycloakId(locationHeader);

            // Define senha corretamente no Keycloak
    ...
    public void resetPassword(String userId, String senha) {
        ...
        try {
            ...
            throw new KeycloakIntegrationException(
                    "Erro ao definir senha no Keycloak: "
                            + ex.getResponseBodyAsString()
            );
        }
